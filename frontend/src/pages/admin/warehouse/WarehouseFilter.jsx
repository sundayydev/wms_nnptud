...
export default function WarehouseFilter({ onSearch, onOpenModal }) {
  ...
  return (
    <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <Button type="primary" size="large" icon={<PlusOutlined />} onClick={() => onOpenModal()} className="rounded-lg font-semibold bg-indigo-600 hover:bg-indigo-500 shadow-md shadow-indigo-500/20 w-full lg:w-auto border-0">
          Thêm Mới Kho
        </Button>
      </div>
    </div>
