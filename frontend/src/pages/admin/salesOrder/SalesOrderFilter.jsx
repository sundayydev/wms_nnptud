...
export default function SalesOrderFilter({ onSearch, onOpenModal }) {
  ...
  return (
    <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <Space wrap size="middle" className="flex-1">
          ...
          <Select 
            ...
            options={[
              ...
              { value: 'Delivered', label: 'Hoàn tất (Delivered)' },
        ...
        <Button type="primary" size="large" icon={<PlusOutlined />} onClick={() => onOpenModal()} className="rounded-lg font-semibold bg-rose-600 hover:bg-rose-500 shadow-md shadow-rose-500/20 w-full lg:w-auto border-0">
          Tạo Đơn Xuất
        </Button>
      </div>
    </div>
