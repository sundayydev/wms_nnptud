...
export default function PurchaseOrderFilter({ onSearch, onOpenModal }) {
  ...
  return (
    <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 mb-6">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <Button type="primary" size="large" icon={<PlusOutlined />} onClick={() => onOpenModal()} className="rounded-lg font-semibold bg-violet-600 hover:bg-violet-500 shadow-md shadow-violet-500/20 w-full lg:w-auto border-0">
          Tạo Đơn Nhập
        </Button>
      </div>
    </div>
