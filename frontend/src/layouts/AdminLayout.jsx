...
export default function AdminLayout() {
  const menuItems = [
    ...
    },
    {
      ...
      label: <Link to="/admin/products">Khối Sản phẩm</Link>,
    },
    {
      key: "categories",
      icon: <AppstoreOutlined />,
      label: <Link to="/admin/categories">Khối Danh mục</Link>,
    },
    {
      key: "warehouses",
      icon: <ShopOutlined />,
    ...
    },
    {
      key: "purchase-orders",
      icon: <ImportOutlined />,
      label: <Link to="/admin/purchase-orders">Nhập Hàng (PO)</Link>,
    },
    {
      key: "sales-orders",
      icon: <ExportOutlined />,
      label: <Link to="/admin/sales-orders">Xuất Hàng (SO)</Link>,
    },
    {
      key: "shipments",
      icon: <ExportOutlined />,
      label: <Link to="/admin/shipments">Giao Hàng</Link>,
    },
    {
      key: "notifications",
      icon: <BellOutlined />,
    ...
    },
    {
      ...
      label: <Link to="/admin/auditlog">Lịch Sử Thao Tác</Link>,
    },
  ];
    ...
    <Layout className="min-h-screen">
      ...
      >
        ...
        <Menu
          ...
          items={menuItems}
          className="pt-4 font-medium border-r-0"
        />
      </Sider>
      ...
      <Layout className="bg-slate-50">
        <Header className="bg-white px-6 shadow-sm flex items-center justify-end h-16 w-full leading-normal z-0 relative">
          <div className="font-semibold text-gray-700 flex items-center gap-3">
            ...
            <Link
              to="/"
              className="text-red-500 ml-6 hover:text-red-700 bg-red-50 hover:bg-red-100 px-4 py-1.5 rounded-md cursor-pointer transition flex items-center gap-2 border border-red-100 text-sm shadow-sm h-9"
            >
